...
def generate_content(message_list, last_content):
    ...
    if response and response.choices:
        ...
        if result:
            npc_item = { "content": result.group(1), "prompt": message_list }
